...
pub trait add_event {
    ...
    fn add_event(&self, with: u128, to: u128) -> __sdk::Result<()>;
    ...
    fn on_add_event(
        &self,
        callback: impl FnMut(&super::ReducerEventContext, &u128, &u128) + Send + 'static,
    ) -> AddEventCallbackId;
...
impl add_event for super::RemoteReducers {
    fn add_event(&self, with: u128, to: u128) -> __sdk::Result<()> {
        self.imp
            .call_reducer("add_event", AddEventArgs { with, to })
    }
    fn on_add_event(
        &self,
        mut callback: impl FnMut(&super::ReducerEventContext, &u128, &u128) + Send + 'static,
    ) -> AddEventCallbackId {
        AddEventCallbackId(self.imp.on_reducer(
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event:
                        __sdk::ReducerEvent {
                            reducer: super::Reducer::AddEvent { with, to },
                            ..
                        },
                    ..
                } = ctx
