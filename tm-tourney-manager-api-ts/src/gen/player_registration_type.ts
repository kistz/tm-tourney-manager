...
let _cached_PlayerRegistration_type_value: __AlgebraicTypeType | null = null;
...
export const PlayerRegistration = {
  ...
  */
  getTypeScriptAlgebraicType(): __AlgebraicTypeType {
    if (_cached_PlayerRegistration_type_value) return _cached_PlayerRegistration_type_value;
    _cached_PlayerRegistration_type_value = __AlgebraicTypeValue.Product({ elements: [] });
    _cached_PlayerRegistration_type_value.value.elements.push(
    ...
    return _cached_PlayerRegistration_type_value;
  },
