...
let _cached_CreateServerConfig_type_value: __AlgebraicTypeType | null = null;
...
export const CreateServerConfig = {
  ...
  */
  getTypeScriptAlgebraicType(): __AlgebraicTypeType {
    if (_cached_CreateServerConfig_type_value) return _cached_CreateServerConfig_type_value;
    _cached_CreateServerConfig_type_value = __AlgebraicTypeValue.Product({ elements: [] });
    _cached_CreateServerConfig_type_value.value.elements.push(
      { name: "id", algebraicType: __AlgebraicTypeValue.String },
      { name: "config", algebraicType: ServerConfig.getTypeScriptAlgebraicType() },
    );
    return _cached_CreateServerConfig_type_value;
  },
