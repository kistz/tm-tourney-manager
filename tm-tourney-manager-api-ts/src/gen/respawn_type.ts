...
export const Respawn = {
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: Respawn): void {
    __AlgebraicTypeValue.serializeValue(writer, Respawn.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): Respawn {
    return __AlgebraicTypeValue.deserializeValue(reader, Respawn.getTypeScriptAlgebraicType());
  },
