...
let _cached_PlayerDisconnect_type_value: __AlgebraicTypeType | null = null;
...
export const PlayerDisconnect = {
  ...
  */
  getTypeScriptAlgebraicType(): __AlgebraicTypeType {
    if (_cached_PlayerDisconnect_type_value) return _cached_PlayerDisconnect_type_value;
    _cached_PlayerDisconnect_type_value = __AlgebraicTypeValue.Product({ elements: [] });
    _cached_PlayerDisconnect_type_value.value.elements.push(
      { name: "login", algebraicType: __AlgebraicTypeValue.String },
      { name: "disconnectReason", algebraicType: __AlgebraicTypeValue.String },
    );
    return _cached_PlayerDisconnect_type_value;
  },
