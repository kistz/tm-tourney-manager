...
export const PlayLoopEnd = {
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: PlayLoopEnd): void {
    __AlgebraicTypeValue.serializeValue(writer, PlayLoopEnd.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): PlayLoopEnd {
    return __AlgebraicTypeValue.deserializeValue(reader, PlayLoopEnd.getTypeScriptAlgebraicType());
  },

}

export default PlayLoopEnd;
