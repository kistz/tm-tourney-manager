...
export const PostEvent = {
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: PostEvent): void {
    __AlgebraicTypeValue.serializeValue(writer, PostEvent.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): PostEvent {
    return __AlgebraicTypeValue.deserializeValue(reader, PostEvent.getTypeScriptAlgebraicType());
  },
