...
export const CreateEventTemplate = {
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: CreateEventTemplate): void {
    __AlgebraicTypeValue.serializeValue(writer, CreateEventTemplate.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): CreateEventTemplate {
    return __AlgebraicTypeValue.deserializeValue(reader, CreateEventTemplate.getTypeScriptAlgebraicType());
  },
