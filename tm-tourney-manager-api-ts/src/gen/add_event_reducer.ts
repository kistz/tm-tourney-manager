...
export const AddEvent = {
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: AddEvent): void {
    __AlgebraicTypeValue.serializeValue(writer, AddEvent.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): AddEvent {
    return __AlgebraicTypeValue.deserializeValue(reader, AddEvent.getTypeScriptAlgebraicType());
  },
