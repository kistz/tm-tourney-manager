...
export const TryStart = {
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: TryStart): void {
    __AlgebraicTypeValue.serializeValue(writer, TryStart.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): TryStart {
    return __AlgebraicTypeValue.deserializeValue(reader, TryStart.getTypeScriptAlgebraicType());
  },

}

export default TryStart;
