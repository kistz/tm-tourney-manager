...
export const PlayerConnect = {
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: PlayerConnect): void {
    __AlgebraicTypeValue.serializeValue(writer, PlayerConnect.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): PlayerConnect {
    return __AlgebraicTypeValue.deserializeValue(reader, PlayerConnect.getTypeScriptAlgebraicType());
  },
