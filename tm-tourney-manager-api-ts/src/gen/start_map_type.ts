...
export const StartMap = {
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: StartMap): void {
    __AlgebraicTypeValue.serializeValue(writer, StartMap.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): StartMap {
    return __AlgebraicTypeValue.deserializeValue(reader, StartMap.getTypeScriptAlgebraicType());
  },
