...
let _cached_MapPoolConfig_type_value: __AlgebraicTypeType | null = null;
...
export const MapPoolConfig = {
  ...
  */
  getTypeScriptAlgebraicType(): __AlgebraicTypeType {
    if (_cached_MapPoolConfig_type_value) return _cached_MapPoolConfig_type_value;
    _cached_MapPoolConfig_type_value = __AlgebraicTypeValue.Product({ elements: [] });
    _cached_MapPoolConfig_type_value.value.elements.push(
    ...
    return _cached_MapPoolConfig_type_value;
  },
