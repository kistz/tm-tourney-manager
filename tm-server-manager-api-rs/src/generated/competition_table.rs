...
pub trait competitionQueryTableAccess {
    #[allow(non_snake_case)]
    /// Get a query builder for the table `CompetitionV1`.
    fn competition(&self) -> __sdk::__query_builder::Table<CompetitionV1>;
}

impl competitionQueryTableAccess for __sdk::QueryTableAccessor {
    fn competition(&self) -> __sdk::__query_builder::Table<CompetitionV1> {
        __sdk::__query_builder::Table::new("competition")
    }
}
